...
from GDSC.MOFGCN.myutils import exp_similarity, full_kernel, sparse_kernel, jaccard_coef, torch_corr_x_y, \
...
class GModel(nn.Module, ABC):
    def __init__(self, adj_mat, gene, cna, mutation, sigma, k, iterates, feature_drug, n_hid1, n_hid2, alpha,
        ...
        feature = fusioner()
        # result1 = np.array(feature)
        # np.savetxt(r'D:\xiang_needread\项目代码（重要）\MOFGCN-main\GDSC\processed_data\npresult1.txt', result1)
        #print('fusioner', feature)
