...
def predicting(model, device, loader):
    ...
    y_true = total_labels.numpy().flatten()
    y_pred = total_preds.numpy().flatten()
    y_t=[]
    y_p=[]
    for i in y_pred:
        if i > 0.5:
    ...
    print('y_pred: ', Counter(y_p))
    print('y_true: ', Counter(y_t))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_batch', type=int, required=False, default=1024,  help='Batch size training set') #1024
    parser.add_argument('--val_batch', type=int, required=False, default=1024, help='Batch size validation set')#1024
    parser.add_argument('--test_batch', type=int, required=False, default=1024, help='Batch size test set')#1024
